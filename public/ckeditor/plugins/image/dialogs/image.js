    ...
    var v = function(d, l) {
        ...
        return {
            ...
            contents: [{
                ...
                }, { type: "button", id: "browse", className: "cke_dialog_image_browse", filebrowser: { action: "Browse", target: "Link:txtUrl", url: d.config.filebrowserImageBrowseLinkUrl }, style: "float:right", hidden: false, label: d.lang.common.browseServer }, {
                    id: "cmbTarget",
                    type: "select",
